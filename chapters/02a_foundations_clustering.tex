...
\begin{algorithm}[t]
  ...
  \caption{K-means algorithm}\label{lag:k-means}
\end{algorithm}

 Squared error algorithms 

\item \textbf{Agglomerative Hierarchical Clustering Algorithm}. 
